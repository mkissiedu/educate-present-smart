...
import { Building2, Crown, Users, BarChart3, Settings, MessageSquare, Database, Calendar, ShieldCheck, ArrowRightLeft } from 'lucide-react';
      ...
      <div className="max-w-7xl mx-auto px-4 py-6">
        ...
        {activeTab === 'questions' && (
          <div className="text-center py-8">
            ...
            <button onClick={() => navigate('/question-bank')} className="bg-purple-600 hover:bg-purple-700 text-white px-6 py-3 rounded-full font-medium transition-all">Open Question Bank</button>
          </div>
        )}
